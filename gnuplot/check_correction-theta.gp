...
plot ref_la u 1:(atan2($6,$2)) w l title 'ref', \
     cor_la u 1:(atan2($6,$2)) w l title 'cor', \
     offset u 1:4 w l title 'offset'
plot ref_ra u 1:(atan2($6,$2)) w l, cor_ra u 1:(atan2($6,$2)) w l

plot ref_com u 1:3 w l, cor_com u 1:3 w l
plot ref_zmp u 1:3 w l, cor_zmp u 1:3 w l
unset multiplot
